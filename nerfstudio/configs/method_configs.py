...
#             "optimizer": AdamOptimizerConfig(lr=0.0025, eps=1e-15),
#             "scheduler": ExponentialDecaySchedulerConfig(
#                 lr_final=0.0025 / 5, max_steps=30001, warmup_steps=30000, lr_pre_warmup=0.0025
#             ),
#         },
#         "features_rest": {
#             "optimizer": AdamOptimizerConfig(lr=0.0025 / 20, eps=1e-15),
#             "scheduler": ExponentialDecaySchedulerConfig(
#                 lr_final=0.0005 / 20, max_steps=30001, warmup_steps=30000, lr_pre_warmup=0.0025 / 20
#             ),
#         },
#         "opacities": {
#             "optimizer": AdamOptimizerConfig(lr=0.05, eps=1e-15),
#              "scheduler": ExponentialDecaySchedulerConfig(
#                 lr_final=0.005 / 5, max_steps=30001, warmup_steps=30000, lr_pre_warmup=0.005
#             ),
#         },
#         "scales": {
#             "optimizer": AdamOptimizerConfig(lr=0.005, eps=1e-15),
...
#         "quats": {"optimizer": AdamOptimizerConfig(lr=0.001, eps=1e-15), "scheduler": None},
#         "camera_opt": {
#             "optimizer": AdamOptimizerConfig(lr=1e-12, eps=1e-15),
#                         "scheduler": ExponentialDecaySchedulerConfig(
